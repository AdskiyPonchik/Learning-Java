...
/** Node in a k-ary search tree.<p>
    ...
    Note that there are {@code k-1} keys for {@code k=}{@link #getK}
    children.  The node always stores {@code getK()} entries where the
    leftmost (0-th) key is {@code null} by definition. (This way we
    store always pairs of keys and children in {@link KTreeNode.Entry}
    and avoid a special case.)<p>
