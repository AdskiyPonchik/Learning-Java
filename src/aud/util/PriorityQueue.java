...
import aud.graphen.adt.AbstractPriorityQueue;
import aud.hashmap.HashMap;
/**
 ...
 * {@code java.util.PriorityQueue} to implement Dijkstra's
 * algorithm. In this case you need to replace {@link #lower} by
 * calling {@code remove} followed by {@code add}, which changes
 * priority. <br> Note that, e.g., the C++ standard library provides
 * only a data structure {@code std::priority_queue} that does
